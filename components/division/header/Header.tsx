...
const Header = (props: HeaderProps) => {
  ...
  const { activeTab = ROUTERS.DIVISION.BASE, onTabChange } = props;
  ...
  const navItems = [
    ...
    { id: ROUTERS.DIVISION.INVOICE, label: "Quản lý hóa đơn" },
    { id: ROUTERS.DIVISION.CUSTOMER, label: "Quản lý khách hàng" },
    // { id: ROUTERS.DIVISION.REVENUE, label: "Quản lý doanh thu" },
  ];
