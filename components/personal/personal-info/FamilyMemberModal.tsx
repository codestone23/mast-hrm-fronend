...
const FamilyMemberModal: React.FC<FamilyMemberModalProps> = ({
  ...
  const isSubmitDisabled = isLoading || !formData.name || !formData.relationship || !formData.gender || !formData.birthDate;

  return (
    <Modal
      isOpen={isOpen}
      onClose={handleClose}
      title={mode === 'add' ? 'Thêm thông tin thân nhân' : 'Chỉnh sửa thông tin thân nhân'}
      size="md"
      footer={
        <>
            ...
            <FormSection>
              <FormGrid>
                ...
                <Select
                  ...
                  onChange={(value) => handleInputChange('relationship', String(value))}
                ...
                <Select
                  ...
                  onChange={(value) => handleInputChange('dependent', String(value))}
