...
import { Grid3X3, User, Lock, LogOut } from "lucide-react";
...
const SettingsHeader = (props: SettingsHeaderProps) => {
  ...
  const { activeTab = "settings/accounts", onTabChange } = props;
  ...
  const navItems = [
    { id: "settings/accounts", label: "Quản lý tài khoản" },
    { id: "settings/divisions", label: "Các divisions" },
  ];
