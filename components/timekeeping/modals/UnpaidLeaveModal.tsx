...
const UnpaidLeaveModal: React.FC<UnpaidLeaveModalProps> = ({
  isOpen,
  onClose,
  selectedDate
}) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      showSuccessToast('Đăng ký nghỉ không lương thành công!');
      onClose();
    } catch (error) {
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={handleClose}
      title="Đăng ký nghỉ không lương"
      size="md"
      footer={
        <>
...
export default UnpaidLeaveModal;
